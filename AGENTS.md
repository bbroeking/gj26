...
- `~/.Codex/projects/-Users-bbroeking-projects-gj26/memory/` — auto memory; user/feedback/project notes accumulated across sessions. The most load-bearing entry is `feedback_blender_bevel_pipeline.md` — read it before authoring a new GLB.
